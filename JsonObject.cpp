...
JsonObject::JsonObject(JsonValueType type, std::string key, std::string value) : valueType(type), key(key), 
    value(value), next(nullptr), children(std::vector<JsonObject*>()) {
